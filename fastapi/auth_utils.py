...
class AuthJwtCsrf():
    ...
    def verify_pw(self, plain_pwd, hashed_pw) -> bool:
        return self.pwd_ctx.verify(plain_pwd, hashed_pw)
    ...
    def decode_jwt(self, token) -> str:
        try:
            payload = jwt.decode(token, self.sercret_key, algorithms=["HS256"])
            return payload["sub"]
